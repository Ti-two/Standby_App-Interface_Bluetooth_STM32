...
# Mise en forme définitive de la ligne
  $App_Compil_Info_Long = "$SW_Name$SW_Version_WithoutPoint du $mday\/$month\/$year a $hour:$min:$sec"." "x33;
...
# Creation et remplissage du fichier app.c
  ...
  print APP_FILE "*******************************************************************************\/\n";
  print APP_FILE "\/*******************************************************************************\n";
  print APP_FILE "*  Library Include Files														  *\n";
  print APP_FILE "*******************************************************************************\/\n";
  print APP_FILE "\#include	\"hwi.h\" \n";
