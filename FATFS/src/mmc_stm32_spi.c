...
static void init_spi(void){
	Hwi_Spi_SDCard_Cs_Init();
	Hwi_Spi_SDCard_ChipDeselect();
	HWI_Timer_Sd_Delay_ms(10);
}
...
static void deselect (void){
	Hwi_Spi_SDCard_ChipDeselect();		/* Set CS# high */
...
{
	Hwi_Spi_SDCard_ChipSelect();		/* Set CS# high */
...
DSTATUS disk_initialize (
	...
	Hwi_Spi_Slow_Init(); /* Set slow clock */
	for (n = 10; n; n--){
	...
	deselect();
	if (ty) {			/* OK */
		Hwi_Spi_Fast_Init();			/* Set fast clock */
