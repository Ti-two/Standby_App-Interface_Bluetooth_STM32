/*******************************************************************************
*  Synergie Ingï¿½nierie Industirelle Co.
*
*  This document is the property of Synergie Ingï¿½nierie Industrielle
...
const U8   *ptr_app_gestion_wifi_blt;
    ...
    p_l_adresse_logique_mod = *(U8_CAL*)(P_L_ADR_LOGIQUE_MODULE_OLD);
